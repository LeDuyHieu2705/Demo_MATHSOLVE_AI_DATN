...
import com.math.solver.mathsolverapp.ui.cropper.CropImageView.RequestSizeOptions
...
data class CropImageOptions @JvmOverloads constructor(
    ...
    @JvmField var showProgressBar: Boolean = false,
