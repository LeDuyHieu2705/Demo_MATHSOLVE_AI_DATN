...
import com.math.solver.mathsolverapp.ui.cropper.CropOverlayView.CropWindowChangeListener
import com.math.solver.mathsolverapp.ui.cropper.utils.getFilePathFromUri
...
class CropImageView @JvmOverloads constructor(
    ...
    CropOverlayView.SetWindowAnimation {
...
//    private var mScanAnimationLoading: ScanAnimationLoading? = null
    ...
    private var mOnSetWindowScanChange: SetWindowAnimation? = null
    ...
    fun setOnWindowScanChange(listener: SetWindowAnimation?) {
        mOnSetWindowScanChange = listener
    }
    ...
    fun clearAll() {
        try {
            mCropOverlayView?.destroyDrawingCache()
            mImageMatrix.reset()
...
//        Log.d("sobutag","startCropWorkerTask")
...
//        Log.d("sobu", "handleCropWindowChanged")
        val width = width
        val height = height
...
//        Log.d("sobu", "mapImagePointsByImageMatrix")
        mImagePoints[0] = 0f
        mImagePoints[1] = 0f
...
//        Log.d("sobu", "setCropOverlayVisibility")
...
//        }
    ...
    fun interface SetWindowAnimation {
        fun onSetScanLoading(rect: RectF, left: Float, right: Float)
    }

    fun interface OnCropImageWhenChange {
        fun onCropWhenChange(view: CropImageView, result: CropResult)
    }
    ...
    init {
        ...
        mCropOverlayView.setWindowAnimation(this)
        mCropOverlayView.setInitialAttributeValues(options)
...
//        Log.d("sobutag","onSetScanLoading")
//        Log.d("sobutag","rect: $rect, cropRect: $cropRect")
        mOnSetWindowScanChange?.onSetScanLoading(rect, left, right)
    }
}
