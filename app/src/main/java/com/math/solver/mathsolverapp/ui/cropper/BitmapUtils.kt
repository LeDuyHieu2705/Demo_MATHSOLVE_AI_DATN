...
import com.math.solver.mathsolverapp.ui.cropper.CropException
import com.math.solver.mathsolverapp.ui.cropper.CropImageView.RequestSizeOptions
import com.math.solver.mathsolverapp.ui.cropper.utils.getUriForFile
import java.io.File
...
internal object BitmapUtils {
  ...
  private fun cropBitmapObjectWithScale(
    ...
    if (result == bitmap) {
      ...
      result = bitmap.config?.let { bitmap.copy(it, false) } ?: createBitmap(64,64,Bitmap.Config.ARGB_8888)
    }
